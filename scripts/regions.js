...
var data = {
    ...
    districts: [
        ...
        // 雲林縣
        [
            ['斗南鎮', '大埤鄉', '虎尾鎮', '土庫鎮', '褒忠鄉', '東勢鄉', '臺西鄉', '崙背鄉',
        ...
        [
            ['新興區', '前金區', '苓雅區', '鹽埕區', '鼓山區', '旗津區', '前鎮區', '三民區',
                ...
                '湖內區', '鳳山市', '大寮區', '林園區', '鳥松區', '大樹區', '旗山區', '美濃區',
        ...
        // 屏東縣
        [
            ['屏東市', '三地門鄉', '霧臺鄉', '瑪家鄉', '九如鄉', '里港鄉', '高樹鄉', '鹽埔鄉',
...
function addOptions() {
    ...
    var districts = data.districts[0];
    var districtsName = districts[0];
    var districtsNum = districts[1];
    var selectCountries = document.getElementById('countries');
    var selectDistricts = document.getElementById('districts');

    for (var i = 0; i < countries.length; i++) {
        var optionC = document.createElement('option');
        optionC.value = i;
        optionC.text = countries[i];
        selectCountries.add(optionC);
    }

    for (var i = 0; i < districtsName.length; i++) {
        var optionD = document.createElement('option');
        optionD.value = districtsNum[i];
        optionD.text = districtsName[i];
        selectDistricts.add(optionD);
    }
}
...
function clearOptions() {
    var selectDistricts = document.getElementById('districts');
    do{
        selectDistricts.remove(selectDistricts.length - 1);
    } while(selectDistricts.length > 0)
    getDistricts();
}

function getDistricts() {
    var countries = document.getElementById("countries").value;
    var districts = data.districts[countries];
    var districtsName = districts[0];
    var districtsNum = districts[1];
    var selectDistricts = document.getElementById('districts');
    ...
    for (var i = 0; i < districtsName.length; i++) {
        ...
        option.value = districtsNum[i];
        option.text = districtsName[i];
